...
namespace ChooseYourOwnAdventure
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("It begins on a cold rainy night. You are sitting in your room and hear a noise coming from down the hall. Do you go investigate?");
            Console.WriteLine("Type YES or NO: ");
            string noiseChoice = Console.ReadLine();
            string fnoiseChoice = noiseChoice.ToUpper();
            if (fnoiseChoice == "NO")
            {
                Console.WriteLine("Not much of an adventure if we don't leave our room!");
                Console.WriteLine("THE END!");
            }
            else if (fnoiseChoice == "YES")
            {
                ...
                string fdoorChoice = doorChoice.ToUpper();
                if (fdoorChoice == "KNOCK")
                {
                    ...
                    string friddleAnswer = riddleAnswer.ToUpper();
                    if (friddleAnswer == "NOTHING")
                    {
                ...
                else if (fdoorChoice == "OPEN")
                {
                    Console.WriteLine("The door is locked! See if one of your three keys will open it");
                    Console.WriteLine("Enter a number (1-3): ");
                    string keyChoice = Console.ReadLine();
                    string fkeyChoice = keyChoice.ToUpper();
                    ...
                    switch (fkeyChoice)
                    {
                        ...
                        case "3":
                            ...
                            break;
                        default:
                            Console.WriteLine("Please choose a key carefully");
                            break;
